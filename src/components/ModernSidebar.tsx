...
export function ModernSidebar() {
  ...
  return (
    <div
      ...
      className={cn(
        "fixed left-4 top-1/2 -translate-y-1/2 z-40 hidden md:flex rounded-[2.5rem] bg-sidebar-background/95 backdrop-blur-sm border border-sidebar-border shadow-lg transition-all duration-300 ease-in-out flex flex-col py-4 px-3",
        isExpanded ? "w-64" : "w-16",
      )}
    >
      {/* Atalhos visíveis */}
      <div className="flex-1 flex flex-col items-center gap-3 px-1">
          ...
          return (
            <button
              ...
              className={cn(
                ...
                isExpanded ? "px-4 py-3 w-full justify-start" : "w-12 h-12 justify-center",
                active
